...
public static final double[] LAUNCHER_LIMELIGHT_DISTANCE_IDX =      {1.15,  2,      2.5,    3,      4,      5,      5.2,    6};
    ...
    public static final double[] LAUNCHER_LIMELIGHT_MOTOR_SPEEDS =  {2600,  2600,   2775,   2950,   3200,   3900,   4500,   5300};//{3500, 3700, 4100, 4500, 5300};
    public static final double[] LAUNCHER_TOP_ROLLER_BACKSPIN_GAIN_LL = {0.7, 0.7, 0.7, 0.7, 0.8, 1.0, 1.0, 1.0};
    public static final double TOF_SCALER = 0.7;
    ...
    public static final double TOF_SCALER_LONGITUDINAL = 1.2;
