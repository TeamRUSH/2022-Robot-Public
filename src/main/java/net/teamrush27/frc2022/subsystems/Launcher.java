...
*/
	...
	public void setLimelightShot() {
		...
		if (limelight.hasTargets()) {
			periodicIO.hoodAngle =  oneDimensionalLookup.interpLinear(LAUNCHER_LIMELIGHT_DISTANCE_IDX, LAUNCHER_LIMELIGHT_HOOD_ANGLES, periodicIO.limelightDistanceToTarget);
			periodicIO.outputValue = oneDimensionalLookup.interpLinear(LAUNCHER_LIMELIGHT_DISTANCE_IDX, LAUNCHER_LIMELIGHT_MOTOR_SPEEDS, periodicIO.limelightDistanceToTarget);
			...
			periodicIO.topRollerSpeedTgt = calculateTopRollerSpeed(periodicIO.outputValue, oneDimensionalLookup.interpLinear(LAUNCHER_LIMELIGHT_DISTANCE_IDX, LAUNCHER_TOP_ROLLER_BACKSPIN_GAIN_LL, periodicIO.limelightDistanceToTarget));
		}
	}
